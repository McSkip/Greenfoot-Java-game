...
/**
 * Write a description of class infire here.
 * 
 * @author (your name) 
 * @version (a version number or a date)
 */
public class infire extends Actor
{
    /**
     * Act - do whatever the infire wants to do. This method is called whenever
    ...
    public void act()
    {
        Infinite myW = (Infinite) getWorld();
